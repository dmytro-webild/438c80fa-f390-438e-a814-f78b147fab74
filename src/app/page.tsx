...
export default function LandingPage() {
  ...
  <div id="nav" data-section="nav">
      ...
      navItems={[
        ...
        {
          name: "About Rajiv Sir",          id: "#about-rajiv-sir"},
        {
  ...
  <div id="about-rajiv-sir" data-section="about-rajiv-sir">
    <MediaAbout
      title="About Rajiv Sir"
      description={`Rajiv Sir\n\nPosition: Director, VERMA TUTORIAL (V.T.)\nExperience: 15+ Years\n\nAs the visionary Director and an experienced educator, Rajiv Sir leads VERMA TUTORIAL with a commitment to academic excellence. With over 15 years of rich experience, he specializes in crafting comprehensive curricula and personalized strategies. His proven methodologies foster deep understanding and strong problem-solving skills across various subjects and competitive exams, empowering students to build confidence and a robust foundation for their future success.`}
      imageSrc="https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3EUEuqRBnlEIWiABQ51jqKM5qld/uploaded-1780810842503-1bskj4qc.png"
      imageAlt="Rajiv Sir, Director of VERMA TUTORIAL, professional headshot"
      useInvertedBackground={false}
      ariaLabel="Premium About Rajiv Sir section"
    />
  </div>
